      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start">
          ...
          <span className="text-gray-600">
            Email: <a href="mailto:ktx@sinhvien.edu.vn" className="text-blue-600 hover:underline">ktx@sinhvien.edu.vn</a>
          </span>
        </div>
        
        <div className="flex items-start">
          <ClockIcon className="h-6 w-6 text-blue-500 mr-3 flex-shrink-0" />
          <span className="text-gray-600">Giờ làm việc: Thứ 2 - Thứ 6, 08:00 - 17:00</span>
        </div>
      </div>
    </div>
  );
