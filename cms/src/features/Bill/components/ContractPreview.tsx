    ...
    <div id="contract-preview" className="bg-white p-8 shadow-md max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <p className="text-sm mb-4">
          Hôm nay, ngày {new Date().getDate()} tháng {new Date().getMonth() + 1} năm {new Date().getFullYear()}, tại Ký túc xá Trường Đại học Kỹ thuật Công nghiệp Thái Nguyên, chúng tôi gồm:
        </p>

        {/* Party A information */}
        <div className="mb-6">
          <h2 className="font-bold mb-2">BÊN A: {data.school.schoolName.toUpperCase()}</h2>
          <div className="pl-8">
        ...
        {/* Party B information */}
        <div className="mb-6">
          <h2 className="font-bold mb-2">BÊN B: {data.student.full_name.toUpperCase()}</h2>
          <div className="pl-8">
            <div className="grid grid-cols-2 gap-4">
              <p className="text-sm mb-1">Giới tính: {data.student.gender}</p>
        ...
        <div className="mb-6">
          ...
          <div className="pl-8">
            <p className="text-sm mb-1">
              Số phòng: {data.room.name}, Tầng: {data.room.floor}, Nhà: {data.room.building}
            </p>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="pl-8">
            <p className="text-sm mb-1">
              Đơn giá: {data.rental.price}đ/tháng
            </p>
            <p className="text-sm mb-1">
        ...
        <div className="mb-6">
          ...
          <div className="text-sm pl-4">
            <p className="mb-2">1. Bên B có trách nhiệm chấp hành nội quy của KTX và các quy định khác của Nhà trường.</p>
            <p className="mb-2">2. Bên B có trách nhiệm nộp phí KTX đúng hạn theo quy định.</p>
            <p className="mb-2">3. Bên B phải bảo quản tài sản, trang thiết bị trong phòng ở. Nếu làm hư hỏng, mất mát phải bồi thường.</p>
            <p className="mb-2">4. Hợp đồng có hiệu lực kể từ ngày ký. Hai bên cam kết thực hiện đúng nội dung hợp đồng.</p>
          </div>
        </div>
