...
import useAddCategory, { Props, ReceivedProps } from "./hook";
...
const AddCategoryLayout: FC<Props> = ({
  control,
  errors,
  handleSubmit,
  onSubmit,
        ...
        <div className="p-4 flex-1">
          <div className="bg-white rounded-2xl p-4 shadow-md grid grid-cols-12 gap-4">
            ...
            <div className="col-span-6">
              ...
              <AppAutocomplete control={control} name="parentId">
                {categories.map((item) => (
...
const AddCategory: FC<ReceivedProps> = (props) => (
  <AddCategoryLayout {...useAddCategory(props)} />
);
