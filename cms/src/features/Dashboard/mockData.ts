...
export const mockRooms: Room[] = [
    { id: 'A101', name: 'A101', capacity: 4, currentOccupancy: 1, electricityBill: 250000, waterBill: 80000, totalBill: 330000 },
    { id: 'A102', name: 'A102', capacity: 4, currentOccupancy: 1, electricityBill: 280000, waterBill: 75000, totalBill: 355000 },
    { id: 'A103', name: 'A103', capacity: 4, currentOccupancy: 1, electricityBill: 320000, waterBill: 90000, totalBill: 410000 },
    { id: 'A104', name: 'A104', capacity: 4, currentOccupancy: 1, electricityBill: 300000, waterBill: 85000, totalBill: 385000 },
    { id: 'B201', name: 'B201', capacity: 4, currentOccupancy: 1, electricityBill: 270000, waterBill: 70000, totalBill: 340000 },
    { id: 'B202', name: 'B202', capacity: 4, currentOccupancy: 1, electricityBill: 290000, waterBill: 88000, totalBill: 378000 },
    { id: 'B203', name: 'B203', capacity: 4, currentOccupancy: 1, electricityBill: 310000, waterBill: 92000, totalBill: 402000 },
];

export const mockBills: Bill[] = [
    { id: '1', roomId: 'A101', type: 'electricity', amount: 250000, month: 12, year: 2024, isPaid: true, dueDate: '2024-12-31' },
    { id: '2', roomId: 'A101', type: 'water', amount: 80000, month: 12, year: 2024, isPaid: false, dueDate: '2024-12-31' },
    { id: '3', roomId: 'A102', type: 'electricity', amount: 280000, month: 12, year: 2024, isPaid: true, dueDate: '2024-12-31' },
    { id: '4', roomId: 'A102', type: 'water', amount: 75000, month: 12, year: 2024, isPaid: false, dueDate: '2024-12-31' },
];

export const mockActivities: Activity[] = [
    { id: '1', title: 'Họp ban quản lý ký túc xá', description: 'Họp định kỳ hàng tháng', date: '2024-12-15', type: 'meeting' },
    { id: '2', title: 'Bảo trì hệ thống điện', description: 'Kiểm tra và bảo trì hệ thống điện tòa A', date: '2024-12-10', type: 'maintenance' },
    { id: '3', title: 'Giao lưu văn hóa', description: 'Chương trình giao lưu văn hóa giữa các sinh viên', date: '2024-12-08', type: 'event' },
    { id: '4', title: 'Kiểm tra an toàn PCCC', description: 'Kiểm tra định kỳ hệ thống PCCC', date: '2024-12-05', type: 'maintenance' },
    { id: '5', title: 'Sinh nhật tập thể tháng 12', description: 'Tổ chức sinh nhật cho sinh viên có sinh nhật tháng 12', date: '2024-12-20', type: 'event' },
];
