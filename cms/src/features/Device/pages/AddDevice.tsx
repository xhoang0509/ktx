...
import { DeviceActions } from "../services/slice";
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        <div className="bg-white rounded-2xl p-4 shadow-md grid grid-cols-12 gap-4 col-span-3">
                            <div className="col-span-6">
                                <div className="mb-2">Tên thiết bị</div>
                            ...
                            <div className="col-span-6">
                                <div className="mb-2">Loại thiết bị</div>
                            ...
                            <div className="col-span-6">
                                ...
                                <AppNumberInput control={control} name="year_of_manufacture" min={2000} />
                                <div className="text-danger text-xs mt-1">
                            ...
                            <div className="col-span-6">
                                ...
                                <AppSelect control={control} name="status" defaultSelectedKeys={["good"]} >
