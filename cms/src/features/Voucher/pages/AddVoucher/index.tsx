...
import useAddVoucher, { Props, ReceivedProps } from "./hook";
...
const AddVoucherLayout: FC<Props> = ({
  control,
  errors,
  handleSubmit,
  onSubmit,
...
const AddVoucher: FC<ReceivedProps> = (props) => (
  <AddVoucherLayout {...useAddVoucher(props)} />
);
